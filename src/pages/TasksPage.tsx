                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex shrink-0 gap-1">
                    <button
                      ...
                      className="rounded-lg bg-green-700 px-2.5 py-1 text-xs font-medium text-cream-50 transition-colors hover:bg-green-800"
                    >
                      Add
                    </button>
                    <button
                      ...
                      className="rounded-lg px-2.5 py-1 text-xs font-medium text-soil-500 transition-colors hover:bg-cream-200"
                    >
                      Dismiss
                    </button>
                  </div>

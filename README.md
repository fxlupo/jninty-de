...
**Bewässerung**
- Eventlog-Filter für Scheduler- und Zonen-Events erkennen ESP-Eventvarianten robuster

### 1.3.6 (2026-05-06)

**Bewässerung**
- Dashboard zeigt beim nächsten Lauf den tatsächlichen Tag als Heute, Morgen oder Wochentag plus Uhrzeit

### 1.3.5 (2026-05-06)

**Bewässerung**
- Programme werden je Zone in eigenen Karten gruppiert und innerhalb der Zone nach Programm A/B/C sortiert
...
**Bewässerung**
- Dashboard zeigt offene Ventile wie die manuelle Steuerung mit grüner Karte und blinkendem Status
- Web-UI aktualisiert während offener Befehle schneller, damit ESP-Rückmeldungen zeitnah sichtbar werden
...
**Aufgaben**
- Speichern/Abbrechen-Buttons im Bearbeitungsdialog sind jetzt immer sichtbar — Formularinhalt scrollt, Buttons bleiben am unteren Rand fixiert

**Mobile Navigation**
- Aufgaben-Icon aus der mobilen Kopfleiste entfernt (bereits in der Bottom-Bar vorhanden)
